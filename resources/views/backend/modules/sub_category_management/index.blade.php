            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a class="waves-effect waves-light btn btn-sm btn-neutral modal-trigger" data-toggle="modal"
                        data-content="{{ route('sub-category.create') }}" href="#modal1">Add New Sub Category</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class=" col ">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="mb-0">All Sub Category List</h3>
                </div>
                <div class="card-body">
                    <div class="row icon-examples">
                        <div class="table-responsive col-md-12">
                            <table class="table table-bordered sub-category-datatable" id="datatable">
                                <thead>
                                    <th>ID</th>
                                    <th>Name</th>
                                    <th>Position</th>
